...
CREATE TABLE aspivia (Extension varchar(15), Pbx_Date_Time datetime, Duration int, Account_Code int(2), Digits varchar(20), Cost decimal(10,2), Destination varchar(30), Carrier varchar(30), Attribute int(2), Site_id int NOT NULL);
